...
namespace Cseresznye_IASR1J_Web.Data
{
    public partial class CarSharingDbContext : DbContext
    {
        ...
        public virtual DbSet<Rides> Rides { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Rides>(entity =>
            {
                entity.HasKey(e => e.RideId)
                    .HasName("PK__Rides__C5B8C414572504E0");
            ...
            modelBuilder.Entity<Users>(entity =>
            {
                entity.HasKey(e => e.UserId)
                    .HasName("PK__Users__1788CCAC294944BF");
